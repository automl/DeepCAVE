from deepcave.evaluators.epm.rf_with_instances import RandomForestWithInstances
...
class LPI:
    def __init__(self, run: Run):
        ...
        X, y, mapping, id_mapping, types, bounds, configspace = run.transform_configs(
            self, fidelities, states, hyperparameters
        )
        ...
        # Initialize model
        self.model = RandomForestWithInstances(configspace, types, bounds, do_bootstrapping=True)
