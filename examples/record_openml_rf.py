...
def main(argv):
    ...
    with Recorder(cs, objectives=objective, save_path="logs/JJ", prefix=f"rf_openml_{task_id}_smac_{seed}", overwrite=True) as r:
    ...
    #-------- START RANDOM SEARCH --------#
    with Recorder(cs, objectives=objective, save_path="logs/JJ", prefix=f"rf_openml_{task_id}_rs_{seed}", overwrite=True) as r:
