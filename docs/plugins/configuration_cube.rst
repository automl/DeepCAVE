...
to investigate the configurations through 2D or 3D _slices_ of the configuration space,
...
* **Hyperparameters** Here you can select the _slice_ with which to look into the configuration
